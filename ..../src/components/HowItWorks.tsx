    ...
    <section className="py-16 bg-black">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold font-poppins mb-3 text-white">How ByeBro Works</h2>
          <p className="text-gray-300 max-w-3xl mx-auto">Planning a bachelor party has never been easier. Follow these simple steps to create the ultimate experience.</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          <div className="bg-gray-900 rounded-lg p-6 shadow-md flex flex-col items-center text-center">
            <div className="w-16 h-16 bg-black border-2 border-red-600 rounded-full flex items-center justify-center mb-4">
          ...
          <div className="bg-gray-900 rounded-lg p-6 shadow-md flex flex-col items-center text-center">
            ...
            <p className="text-gray-300">Book your trip through our trusted partners, order custom merch, and get ready for an unforgettable bachelor party.</p>
          </div>
        </div>
      </div>
    </section>
